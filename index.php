                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="edit_id_precio_paquete" id="edit_id_precio_paquete" class=" form-control" placeholder="$" required>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="edit_nombre" id="edit_nombre" class=" form-control" placeholder="agua de rosas" required>
                            </div>
